...
2. Check user memory first: read `data/user_memory.json` if it exists and use stored topic preferences, goals, and constraints to pre-fill request parameters.
...
10. Final output should stay short: strategy first, then daily items with title, link, creator, date, and reason.
